...
Tools can be:
- Registered with explicit executors via ``register_executor()``
- Referenced as ``python:<module>.<function>`` for dynamic import
"""
...
class ToolRegistry:
    ...
    Usage:
        ...
        schema = registry.get_tools_schema(['calculate'])
        result = registry.execute_tool('calculate', {'expr': '2+2'})
    ...
    def execute_tool(self, name: str, arguments: dict[str, Any]) -> str:
        ...
        2. ``python:`` implementation (dynamic import)
    ...
    @staticmethod
    def load_python_callable(path: str) -> Callable[..., Any] | None:
